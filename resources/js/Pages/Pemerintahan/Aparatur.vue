    ...
    <MainLayout>
        ...
        <div class="relative bg-slate-900 py-24 overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                <div class="w-16 h-16 mx-auto bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center mb-6 shadow-2xl border border-white/10">
                ...
                <p class="text-slate-400 text-lg md:text-xl max-w-2xl mx-auto font-medium leading-relaxed opacity-80">
                    Mengenal lebih dekat jajaran profesional yang berdedikasi melayani masyarakat Kelurahan Ujung
                    Sabbang.
                </p>
            </div>
        </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div v-if="structures && structures.length > 0"
                    ...
                    <div v-for="(person, index) in structures" :key="person.id"
                        ...
                        <div class="px-2 pb-2">
                            <div class="mb-4">
                                <h3 class="text-base font-black text-slate-900 mb-1 group-hover:text-blue-600 transition-colors duration-300 line-clamp-1 uppercase tracking-tight">
                                    {{ person.name }}
                                </h3>
                                ...
                                <div v-if="person.nip" class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-lg bg-slate-50 border border-slate-100/50">
                            ...
                            <div class="pt-4 border-t border-slate-50">
                                <div v-if="person.parent" class="flex items-center gap-2 group/superior">
                                    <div class="w-6 h-6 rounded-lg bg-slate-50 flex items-center justify-center text-slate-400 group-hover/superior:bg-blue-50 group-hover/superior:text-blue-500 transition-colors">
                                ...
                                <div v-else-if="person.level === 1" class="flex items-center gap-2">
                                    <div class="w-6 h-6 rounded-lg bg-blue-50 flex items-center justify-center text-blue-500">
                                        <i class="fas fa-crown text-[9px]"></i>
                                    </div>
                                    <span class="text-[9px] text-blue-600 font-black uppercase tracking-widest">Kepala Instansi</span>
                                </div>
                        ...
                        <div class="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
                            <div class="absolute top-[-150%] left-[-50%] w-[200%] h-[200%] bg-gradient-to-tr from-white/10 to-transparent rotate-12 animate-shine"></div>
                        </div>
                    </div>
                </div>

                <!-- Empty State -->
                <div v-else class="text-center py-32 bg-white rounded-[3rem] border border-dashed border-slate-200 group relative overflow-hidden">
                    <div class="absolute inset-0 bg-blue-50/30 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                    <div class="relative z-10">
                        <div class="w-20 h-20 bg-blue-50 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-xl shadow-blue-500/5 group-hover:scale-110 transition-transform duration-500">
                        ...
                        <p class="text-slate-500 text-sm font-medium">Informasi jajaran aparatur sedang dalam proses pemutakhiran.</p>
                    </div>
                </div>
            </div>
        </div>
