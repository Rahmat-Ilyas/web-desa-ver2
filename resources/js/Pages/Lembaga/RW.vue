    ...
    <MainLayout>
        ...
        <div class="bg-indigo-900 py-16 relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                <p class="text-indigo-100 text-lg max-w-2xl mx-auto">Daftar Ketua RW dan Cakupan Wilayah di {{ $page.props.settings?.sebutan_wilayah || 'Kelurahan' }}
                        ...
                        <div class="pt-12 px-6 pb-6 bg-white rounded-b-2xl">
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-50">
                                <div class="text-xs text-gray-400 font-medium">
                                    <i class="fas fa-map-marker-alt mr-1"></i> {{ $page.props.settings?.nama_wilayah || '[Nama Wilayah]' }}
                                </div>
