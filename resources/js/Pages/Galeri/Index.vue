...
const nextPhoto = () => {
    if (selectedPhotoIndex.value < (props.galeris?.data?.length || 0) - 1) {
    ...
    <MainLayout>
        ...
        <div class="py-16 bg-white min-h-screen">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <!-- Empty State -->
                <div v-if="!galeris?.data?.length" class="py-20 text-center">
        ...
        <transition enter-active-class="transition duration-300 ease-out" enter-from-class="opacity-0"
            ...
            <div v-if="selectedPhoto" class="fixed inset-0 z-[100] bg-black/95 flex items-center justify-center p-4">
                ...
                <button v-if="selectedPhotoIndex < (galeris?.data?.length || 0) - 1" @click.stop="nextPhoto"
                ...
                <div class="relative max-w-5xl w-full max-h-screen flex flex-col items-center">
                    ...
                    <div class="mt-4 text-center text-white max-w-2xl">
                        <span
                            class="inline-block px-3 py-1 rounded-full bg-blue-600/80 text-[10px] font-black uppercase tracking-widest mb-2 border border-blue-400/30">
